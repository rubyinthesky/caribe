...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post categoria_url, params: { categorium: { id_post: @categorium.id_post, id_usuarios: @categorium.id_usuarios, nombre: @categorium.nombre } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { id_post: @categorium.id_post, id_usuarios: @categorium.id_usuarios, nombre: @categorium.nombre } }
